                ...
                <div class="col-lg-9" id="faq">
                    ...
                    <div role="tablist" class="add_bottom_45 accordion_2" id="payment">
                        <div class="card">
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#collapseOne_payment" aria-expanded="true"><i class="indicator ti-minus"></i>Formas de pago</a>
                                </h5>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree_payment" class="collapse" role="tabpanel" data-parent="#payment">
                                <div class="card-body">
                                    <p>Se aplican comisiones sobre las contrataciones y ventas por el servicio y mantenimiento de la plataforma.</p>
                                    <p>El servicio por la reserva aplica un 4% de comisión sobre el total de la venta y un 3% por el servicio de contratación.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /card -->
                    ...
                    <div role="tablist" class="add_bottom_45 accordion_2" id="tips">
                        <div class="card">
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a data-toggle="collapse" href="#collapseOne_tips" aria-expanded="true"><i class="indicator ti-plus"></i>Como Reservar</a>
                                </h5>
                            </div>

                            <div id="collapseOne_tips" class="collapse" role="tabpanel" data-parent="#tips">
                                <div class="card-body">
                                    <p>Cuando realizas una busqueda, ingresas las fechas en que queres tomar las clases y la cantidad de personas que van a ser para poder calcular la tarifa. El sistema buscara a los instructores disponibles y mejor calificados, la tarifa de cada instructor puede varíar en razón de la demanda y la oferta.</p>
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseTwo_tips" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Solicitud de reserva</a>
                                </h5>
                            </div>
                            <div id="collapseTwo_tips" class="collapse" role="tabpanel" data-parent="#tips">
                                <div class="card-body">
                                    <p>Cuando hayas encontrado a tu nstructor deberas hacerle una solicitud de reserva, esta etapa sirve para coordinar entre las partes y confirmar que el instructor es el adecuado para tus necesidades.</p>
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseThree_tips" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Cancelacion de la reserva
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseThree_tips" class="collapse" role="tabpanel" data-parent="#tips">
                                <div class="card-body">
                                    <p>Podes cancelar la reserva en cualquier momento si aún no esta confirmada. Si la reserva se confirmo e hiciste el pago solo se te reembolsara la mitad del dinero. Tené en cuenta que cancelar una reserva sin motivos de fuerza mayor implica una pérdida para el instructor sobre otras potenciales reservas y además conlleva gastos.</p>
                    ...
                    <div role="tablist" class="add_bottom_45 accordion_2" id="reccomendations">
                        <div class="card">
                            ...
                            <div id="collapseOne_reccomendations" class="collapse" role="tabpanel" data-parent="#reccomendations">
                                <div class="card-body">
                                    <p>Todos los instructores de snowboard y ski anunciados en la plataforma cuentan con una certificación que los habilita como profesionales en la materia. Podes encontrarlos por niveles, de 3 a 5. Al ser independientes las tarifas las proponen ellos.</p>                                   
                                </div>
                            </div>
                        </div>
                        <!-- /card -->
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseTwo_reccomendations" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Sistema de reputación
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseTwo_reccomendations" class="collapse" role="tabpanel" data-parent="#reccomendations">
                                <div class="card-body">
                                    <p>Queremos crear un sistema de confianza por lo que vos como cliente podes dejar una puntuacíon por estrellas y un comentario si lo deseas para que otra gente pueda contratar con tranqulidad. Para promover este sistema, al dar tu puntación te damos un cupón de descuento para que te lo guardes y se lo pases a algún familiar o conocido.</p>                       
                                </div>
                            </div>
                        </div>
                        <!-- /card -->
                    ...
                    <div role="tablist" class="add_bottom_45 accordion_2" id="terms">
                        <div class="card">
                            ...
                            <div id="collapseOne_terms" class="collapse" role="tabpanel" data-parent="#terms">
                                <div class="card-body">
                                    <p>Este sitio web es operado por Instructores. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Instructores. Instructores ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo_terms" class="collapse" role="tabpanel" data-parent="#terms">
                                <div class="card-body">
                                    ...
                                    <p>El incumplimiento o violación de cualquiera de estos Términos darán lugar al cese inmediato de los Servicios.</p>
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseFive_terms" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Sección 4 - Modificaciones el servicio y precios
                                    </a>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseSix_terms" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Sección 5 - Productos o servicios (si aplicable)
                                    </a>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" role="tab">
                                <h5 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse" href="#collapseTen_terms" aria-expanded="false">
                                        <i class="indicator ti-plus"></i>Sección 9 - Comentarios de usuario, captación y otros envíos
                                    </a>
                                </h5>
                            </div>
                        ...
                        <!-- /card -->
                            ...
                            <div id="collapseEleven" class="collapse" role="tabpanel" data-parent="#terms">
                                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo_terms" class="collapse" role="tabpanel" data-parent="#terms">
                                <div class="card-body">
                                    <p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de la provincia de Río Negro, Argentina.</p>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwenty_terms" class="collapse" role="tabpanel" data-parent="#terms">
                                <div class="card-body">
                                    <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a info@instructores.com.ar.</p>
