...
class ReservationAvailable extends Validator
{
    ...
    public function fails()
    {
        ...
        if( ($this->request->has("adults_amount") && $this->request->adults_amount > 0 && !$service->offered_to_adults) || ($this->request->has("kids_amount") && $this->request->kids_amount > 0 && !$service->offered_to_kids) ) {
